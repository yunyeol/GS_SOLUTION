...
import gs.mail.engine.job.RealtimeTargetJob;
...
@Slf4j
public class RealtimeTargetExecutor extends JobParameterContents implements Job {

    @Autowired private SimpleJobLauncher simpleJobLauncher;
    @Autowired private RealtimeTargetJob realtimeTargetJob;
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        try{
            ...
            for (Realtime realtime : realtimeSendService.selectRealtimeSchdlList()){
                ...
                JobExecution jobExecution = simpleJobLauncher.run(realtimeTargetJob.realtimeTargetJobDetail(), jobParameters);
            }
